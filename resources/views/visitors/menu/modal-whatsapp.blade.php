    ...
    <div class="p-6">
        <ul class="space-y-4">
            ...
            <li class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition duration-200 ease-in-out flex items-center space-x-4">
                ...
                <a href="https://wa.me/351{{ $visitor->phone_number }}?text=Deus te fortaleça, {{ $visitor->name }}!"
            ...
            <li class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition duration-200 ease-in-out flex items-center space-x-4">
                ...
                <a href="https://wa.me/351{{ $visitor->phone_number }}?text=Estamos orando por você, {{ $visitor->name }}."
                   target="_blank" class="block text-blue-500 font-medium hover:underline">
            ...
            <li class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition duration-200 ease-in-out flex items-center space-x-4">
                ...
                <a href="https://wa.me/351{{ $visitor->phone_number }}?text=Que Deus abençoe sua semana, {{ $visitor->name }}!"
                   target="_blank" class="block text-blue-500 font-medium hover:underline">
        ...
        <form action="https://wa.me/351{{ $visitor->phone_number }}" method="GET" target="_blank" class="mt-4">
