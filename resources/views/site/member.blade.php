                ...
                <ul class="flex justify-center items-center text-small">
                    <template x-for="n in 3" :key="n">
                        <li class="flex items-center mx-2">
                            <button type="button" @click="setStep(n)" :class="{'text-primary': step >= n}" class="flex items-center focus:outline-none text-xs">
                                <span :class="step >= n ? 'bg-primary text-white' : 'bg-gray-200 text-black'" class="w-6 h-6 flex items-center justify-center rounded-full mr-2 transition-colors duration-300 ease-in-out" x-text="n"></span>
                            ...
                            <span x-show="n < 3" class="w-8 border-t" :class="step > n ? 'border-primary' : 'border-gray-300'"></span>
                        </li>
                    </template>
                </ul>
            </div>
            ...
            <form
                ...
                <div x-show="step === 1">
                    ...
                    <div class="mt-4">
                        ...
                        <x-dropdown-select
                            :options="[__('Male') => __('Male'), __('Female') => __('Female')]"
                            selected="{{ old('gender') }}"
                            x-model="gender"
                            placeholder=""
                            name="gender"
                    ...
                    <div class="mt-4">
                        ...
                        <x-dropdown-select
                            :options="[__('Single') => __('Single'), __('Married') => __('Married'), __('Divorced') => __('Divorced'), __('Widowed') => __('Widowed')]"
                            selected="{{ old('marital_status') }}"
                            x-model="marital_status"
                            placeholder=""
                            name="marital_status"
                        />
                ...
                <div x-show="step === 2">
                    ...
                    <div class="mt-4 flex justify-between">
                        <x-secondary-button type="button" @click="setStep(1)" class="bg-gray-300 hover:bg-gray-400 text-black">
                            {{ __('Back') }}
                        </x-secondary-button>
                ...
                <div x-show="step === 3">
                    <div class="mt-4">
                        ...
                        <ul class="mt-4 text-gray-700">
                            <li class="flex justify-between"><strong>{{ __('Full Name') }}:</strong> <span x-text="full_name"></span></li>
                            <li class="flex justify-between"><strong>{{ __('Phone Number') }}:</strong> <span x-text="phone_number"></span></li>
                            <li class="flex justify-between"><strong>{{ __('Gender') }}:</strong> <span x-text="gender"></span></li>
                            <li class="flex justify-between"><strong>{{ __('Marital Status') }}:</strong> <span x-text="marital_status"></span></li>
                            <li class="flex justify-between"><strong>{{ __('NIF') }}:</strong> <span x-text="document_number"></span></li>
                            <li class="flex justify-between"><strong>{{ __('Date of Birth') }}:</strong> <span x-text="formatDate(birthdate)"></span></li>
                            <li class="flex justify-between"><strong>{{ __('Postal Code') }}:</strong> <span x-text="zip_code"></span></li>
                            <li class="flex justify-between"><strong>{{ __('City') }}:</strong> <span x-text="city"></span></li>
                            <li class="flex justify-between"><strong>{{ __('Address') }}:</strong> <span x-text="address"></span></li>
                            <li class="flex justify-between"><strong>{{ __('Address Number') }}:</strong> <span x-text="address_number"></span></li>
                        </ul>
                    </div>
                    <div class="mt-4 flex justify-between">
                        <x-secondary-button type="button" @click="setStep(2)" class="bg-gray-300 hover:bg-gray-400 text-black">
                            {{ __('Back') }}
                        </x-secondary-button>
